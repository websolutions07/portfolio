...
(function () {
  ...
  async function loadDynamicData() {
    try {
      // Fetch Services
      const servicesRes = await fetch('http:///portfolio-7cm8.onrender.com/api/services');
      if (servicesRes.ok) {
      ...
      // Fetch Projects
      const projectsRes = await fetch('http://portfolio-7cm8.onrender.com//api/projects');
      if (projectsRes.ok) {
